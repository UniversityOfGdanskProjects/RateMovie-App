...
userDataRoutes.route('/api/movies/:movieId/addToFavourites').post(addMovieToFavourites);
userDataRoutes.route('/api/movies/:movieId/addToIgnored').post(addMovieToIgnored);
userDataRoutes.route('/api/movies/:movieId/addToWatchlist').post(addMovieToWatchlist);
userDataRoutes.route('/api/movies/:movieId/addToFollowed').post(addMovieToFollowed);

userDataRoutes.delete('/api/removeFromIgnored/:userId/:movieId', removeMovieFromIgnored);
userDataRoutes.delete('/api/removeFromWatchlist/:userId/:movieId', removeMovieFromWatchlist);
userDataRoutes.delete('/api/removeFromFollowed/:userId/:movieId', removeMovieFromFollowed);
userDataRoutes.delete('/api/removeFromFavourites/:userId/:movieId', removeMovieFromFavourites);
userDataRoutes.delete('/api/removeFromReviewed/:userId/:movieId', removeMovieFromReviewed);
